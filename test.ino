...
std::vector<MOTOR_PINS> motorPins =
		{
				{12, 15, 2}, // RIGHT_MOTOR Pins (EnA, IN1, IN2)
				{14, 0, 4},	 // LEFT_MOTOR  Pins (EnB, IN3, IN4)
};
...
void rotateMotor(int motorNumber, int motorDirection)
{
	...
	Serial.printf("PinIN1: %d, PinIN2: %d\n", digitalRead(motorPins[motorNumber].pinIN1), digitalRead(motorPins[motorNumber].pinIN2));
...
{
	Serial.printf("Moving car with input value %d\n", inputValue);
	...
	Serial.printf("After movement - PinIN1: %d, PinIN2: %d\n", digitalRead(motorPins[RIGHT_MOTOR].pinIN1), digitalRead(motorPins[RIGHT_MOTOR].pinIN2));
	Serial.printf("After movement - PinIN1: %d, PinIN2: %d\n", digitalRead(motorPins[LEFT_MOTOR].pinIN1), digitalRead(motorPins[LEFT_MOTOR].pinIN2));
}
